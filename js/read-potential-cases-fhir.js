...
(async () => {
  ...
  await fs.writeFile("illicit-opioid-use-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("illicit-opioid-use-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
